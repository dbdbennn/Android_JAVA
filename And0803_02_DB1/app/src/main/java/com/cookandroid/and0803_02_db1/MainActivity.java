...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtNumber = findViewById(R.id.edtNumPerson);
        ...
        btnSelect = findViewById(R.id.btnShow);
        ...
        btnAm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dlg.setView(v);
                final EditText edtAmGName = v.findViewById(R.id.edtAmName);
                final EditText edtAmNumber = v.findViewById(R.id.edtAmNumber);
